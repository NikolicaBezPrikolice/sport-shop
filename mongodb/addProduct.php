<?php
    ...
    $pname = $ptype= $pprice = $pdesc = "";
    $pnameError = $ptypeError= $ppriceError = $pdescError = $pimageError = "";
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST"){
        ...
        if(!empty($_POST['pprice'])){
            ...
            $ppriceError = "Unesite cenu artikla!";
        }
        ...
        if ($pnameError == ""  && $ptypeError == "" &&  $pdescError ==""){
            $result=$db->products->insertOne(array('pname'=>$pname, 'ptype'=>$ptype, 'pprice'=>$pprice ,'pdesc'=>$pdesc,'pstock'=>'0'));
...
<div class="content">
    ...
    <form action="" method = "POST" enctype="multipart/form-data">
        ...
        <label for="pdesc">Cena:</label><br>
        <input type="number" id="quantity" name="pprice" min="1" value= "<?php echo $pprice ?>">
        <span class="error"><?php echo $ppriceError ?></span><br>
